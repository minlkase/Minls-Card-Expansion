...
function s.extraop(mat,e,tp,eg,ep,ev,re,r,rp,tc)
	...
	Duel.SendtoDeck(mat2,nil,REASON_EFFECT|REASON_MATERIAL|REASON_RITUAL|REASON_RELEASE)
	Duel.SendtoDeck(mat,nil,REASON_EFFECT|REASON_MATERIAL|REASON_RITUAL|REASON_RELEASE)
end
